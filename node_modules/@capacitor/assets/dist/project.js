...
class Project extends project_1.MobileProject {
    ...
    async loadInputAssets() {
        this.assets = {
            ...
            iosNotificationIcon: await this.loadInputAsset('ios/notification-icon', "notification-icon" /* NotificationIcon */, "ios" /* Ios */),
            iosSettingsIcon: await this.loadInputAsset('ios/settings-icon', "settings-icon" /* SettingsIcon */, "ios" /* Ios */),
            iosSpotlightIcon: await this.loadInputAsset('ios/spotlight-icon', "spotlight-icon" /* SpotlightIcon */, "ios" /* Ios */),
