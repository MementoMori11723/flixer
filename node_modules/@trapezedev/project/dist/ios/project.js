...
class IosProject extends platform_project_1.PlatformProject {
    ...
    async getPlistFile(path) {
        return this.getProjectFile(path, (filename) => new plist_2.PlistFile(filename, this.project.vfs));
    }
    getPbxProject() {
    ...
    async setBuild(targetName, buildName, buildNumber) {
        var _a, _b, _c;
        (_a = this.pbxProject) === null || _a === void 0 ? void 0 : _a.updateBuildProperty('CURRENT_PROJECT_VERSION', buildNumber !== null && buildNumber !== void 0 ? buildNumber : 1, buildName, targetName);
    ...
    async plist(filename) {
        ...
        const plistFile = new plist_2.PlistFile(filename, this.project.vfs);
